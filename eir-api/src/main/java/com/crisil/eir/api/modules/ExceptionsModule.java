...
/**
 * the exception work queue: list by status and category, resolve with a mandatory note, accept with approval under four eyes
 *
 ...
 *
 * <p>Specification: {@code docs/06-api-spec.md} 06 § 6.
 */
