...
/**
 * the five transition endpoints: the ACPIR 19 day-1 fair-value run, per-contract fair value with the paragraph 19 rebuttal reference, legacy cohorts, migration, and coverage against the ACPIR 21 and 50 deadlines tracked SEPARATELY
 *
 ...
 *
 * <p>Specification: {@code docs/06-api-spec.md} 06 § 8.
 */
