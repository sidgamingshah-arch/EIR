...
/**
 * POST /api/runs, GET /api/runs/{id}, POST /api/runs/{id}/replay, GET /api/periods, POST /api/periods/{id}/close — the close returns 409 with the failing gates enumerated
 *
 ...
 *
 * <p>Specification: {@code docs/06-api-spec.md} 06 § 4.
 */
